...
export function fixListOfWagons(ids) {
  const [firstwagon, secondwagon, ...reste] = ids

  return [...reste, firstwagon, secondwagon] 
}
...
export function correctListOfWagons(ids, missingWagons) {
  const [firstwagon , ...reste] = ids
  return [firstwagon, ...missingWagons, ...reste]
}
...
export function separateTimeOfArrival(information) {
    const {timeOfArrival, ...reste} = information;
    
  return [timeOfArrival, reste]
}
