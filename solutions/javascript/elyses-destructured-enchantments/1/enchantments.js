...
export function getSecondCard(deck) {
    let [firstCard1, firstCard2] = deck
  return firstCard2
}
...
export function shiftThreeCardsAround(deck) {
      let [firstCard1, firstCard2, firstCard3] = deck
      return [firstCard2, firstCard3, firstCard1]
}
